package org.ieslluissimarro.rag.rag2daw2025.security;

import java.util.List;
import org.ieslluissimarro.rag.rag2daw2025.security.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http    
            ...
            .authorizeHttpRequests(authRequest -> authRequest
                .requestMatchers("/auth/nuevo").permitAll() // Se agrega explícitamente
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("*")); // Permite cualquier origen (solo para pruebas)
